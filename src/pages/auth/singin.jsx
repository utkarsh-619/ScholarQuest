        ...
        <div class="container flex items-center justify-center min-h-screen px-6 mx-auto">
          <form class="w-full max-w-md">
            ...
            <div class="flex items-center justify-center mt-6">
              <a
                href="#"
                class={` w-1/3 pb-4 font-medium text-center ${(!isLogIn)? "text-gray-500 capitalize border-b dark:border-gray-400 dark:text-gray-300" :  "text-gray-800 capitalize border-b-2 border-blue-500 dark:border-blue-400 dark:text-white" }`}
                onClick={() => {
                    setIsLogIn(1)
                }}
              >
            ...
            {!isLogIn && <div class="relative flex items-center mt-6">
              <span class="absolute">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  class="w-6 h-6 mx-3 text-gray-300 dark:text-gray-500"
            ...
            {!isLogIn && <div class="relative flex items-center mt-4">
              <span class="absolute">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  class="w-6 h-6 mx-3 text-gray-300 dark:text-gray-500"
            ...
            <div class="mt-6">
              ...
              <div class="mt-6 text-center " onClick={() => {
                    setIsLogIn(!isLogIn)
              }}>
                <a
                  href="#"
